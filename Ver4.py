...
"border-color: rgb(0, 0, 0);")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 959, 608))               # QRect(0,0,959,608)
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.pushButton = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)                # 페이지2에 들어가는 푸시버튼이 올라가는 위치 - scrollAreaWidgetContets_2 (위젯)에 올라감. -scrollAreaWidgetContents_2 접근 경로
        ...
        self.scrollArea_3.setGeometry(QtCore.QRect(0, 0, 960, 610))                             # QRect(0,0,960,610)
        ...
        self.dial.setGeometry(QtCore.QRect(300, 190, 311, 211))                                 # QRect(300,190,311,211) => 위젯이 올라가는 위치는 (0,0) 기준임.
    ...
    def retranslateUi(self, MainForm):
        ...
        self.subf1_btn.setText(_translate("MainForm", "STRATEGE SELECTION"))
